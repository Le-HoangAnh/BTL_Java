...
public class TaiSan implements Serializable {
    ...
    public TaiSan(String maTS, String tenTS, String dvTinh, String tinhTrang, Date ngayBH, String nguonVon, String soHuu, String mucDich, String danhMuc, String khoaQl) {
        this.maTS = maTS;
        this.tenTS = tenTS;
        this.dvTinh = dvTinh;
