...
public class JQLTaiSan extends javax.swing.JFrame {
    ...
    public void myInit(){
        ...
        dsTSWork=dsTaiSan;
        //Tạo combo danh mục
        String dm[]={"Nhà,công trình xây dựng","Vật kiến trúc","Xe ô tô","Máy móc, thiết bị",
                     "Cây, gia súc","Quyền tác giả","Quyền sở hữu công nghiệp",
                     "Quyền với giống cây trồng","Phần mềm ứng dụng","Khác"};
    ...
    private void initComponents() {
        ...
        jNguonVon = new javax.swing.JTextField();
        ...
        jLabel5.setText("Nguồn vốn");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(312, 87, -1, -1));

        jNguonVon.setToolTipText("");
        jNguonVon.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jNguonVonActionPerformed(evt);
            }
        });
        jPanel1.add(jNguonVon, new org.netbeans.lib.awtextra.AbsoluteConstraints(442, 84, 170, -1));
        ...
        jMenuItem2.setText("Mua sắm tài sản");
        ...
        jMenuItem1.setText("Điều chuyển tài sản");
    ...
    private void tableTSMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableTSMouseClicked
        ...
        if(dongchon !=-1){
            ...
            jNguonVon.setText(tsan.getNguonVon()+"");
        ...
        if(jMaTS.getText().trim().length()==0)
            ...
            try {            
                tsan = new TaiSan(jMaTS.getText(),jTenTS.getText(),jDvTinh.getText(),jTinhTrang.getText(),
                                  format.parse(jNgayBH.getText()),jNguonVon.getText(),jSoHuu.getText(),
    ...
    private void jNguonVonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jNguonVonActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jNguonVonActionPerformed
        ...
        if(dongchon != -1){                        
            ...
            if (response == JOptionPane.YES_OPTION){
                try {
                    ...
                    tsan.setNguonVon(jNguonVon.getText());
    ...
    private javax.swing.JTextField jNguonVon;
